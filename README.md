...
[ Internet (0.0.0.0/0) ]
          │
          ▼
   [ Internet Gateway ] ── Permite comunicación VPC ↔ Internet
          │
          ▼
┌───────────────────────────────────────────────────────────────────────────────┐
│ VPC (10.0.0.0/16) ── Región: us-east-1 (DNS Habilitado)                       │
│                                                                               │
│  ┌─────────────────────────────────────────────────────────────────────────┐  │
│  │ PUBLIC SUBNETS (Alojamiento de recursos con acceso directo a Internet)  │  │
│  │                                                                         │  │
│  │   Route Table Pública: Destino 0.0.0.0/0 ──> Gateway: Internet Gateway  │  │
│  │   Security Group Público: Ingress [80, 443, 22] from 0.0.0.0/0          │  │
...
│                  ▼                        │                 ▼                 │
│  ┌────────────────────────────────────────┼────────────────────────────────┐  │
│  │ PRIVATE SUBNETS (Alojamiento de recursos SIN acceso directo)            │  │
│  │                                                                         │  │
│  │   Route Table Privada: Destino 0.0.0.0/0 ──> Gateway: NAT Gateway       │  │
│  │   Security Group Privado: Ingress [0-65535] ONLY from SG Público        │  │
│  │                           Egress  [Todo permitido]                      │  │
│  │                                                                         │  │
│  │   us-east-1a (10.0.10.0/24)            us-east-1b (10.0.11.0/24)        │  │
│  │   ┌────────────────────────┐           ┌────────────────────────┐       │  │
│  │   │ [ Recursos Privados ]  │           │ [ Recursos Privados ]  │       │  │
│  │   │ (Bases de Datos, etc.) │           │ (Apps Internas, etc.)  │       │  │
│  │   │                        │           │                        │       │  │
│  │   │   Tráfico Saliente ────┼───────────┘                        │       │  │
│  │   └────────────────────────┘                                    │       │  │
│  └─────────────────────────────────────────────────────────────────────────┘  │
